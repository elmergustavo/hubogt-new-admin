            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 flex ">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <!-- descripcion -->
                        <div class="mb-8 ">
                            <span class="text-lg font-medium text-blue-950 underline">Tiendas Buhogt</span>
                            <h2 class="max-w-xl mt-2 mb-6 text-2xl font-bold md:text-4xl">
                                Zapatos Nike</h2>
                            <div class="flex items-center mb-4">
                                <p class="text-sm text-yellow-400 font-medium mr-2">
                                    <span>4.6</span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="w-4 mr-1  text-blue-950  bi bi-star "
                                                viewBox="0 0 16 16">
                                                <path
                        ...
                        <!-- Estilos -->
                        <div class="mb-8">
                            <h2 class="pb-1 mb-4 text-2xl font-bold ">
                        ...
                        <div class="space-y-2 mb-4">
                            <details
                                class="overflow-hidden rounded border border-gray-300 hover:border-2 hover:border-gray-900 [&_summary::-webkit-details-marker]:hidden">
                                <summary
                                    class="flex cursor-pointer items-center justify-between gap-2 bg-white p-4 text-gray-900 transition">
                                    <span class="text-lg font-medium"> Selecciones el tamaño </span>
                                ...
                                <div class="border-t border-gray-200 bg-white">
                                    <header class="flex items-center justify-between p-4">
                                        <span class="text-sm text-gray-700"> Tallas disponibles </span>
                        ...
                        <div>
                            ...
                            <div class="w-full mb-4 lg:w-full lg:mb-4">
                                <button
                                    class="flex items-center justify-center w-full p-4 font-medium text-black  rounded-[5px] text-gray-900 text-lg  bg-blue-50  hover:bg-blue-100 ">
                                    Añadir al carrito
                                </button>
                            </div>
                            <div class="w-full  mb-4 lg:mb-4 lg:w-full">
                                <button
                                    class="flex items-center justify-center w-full p-4 text-white font-medium rounded-[5px] text-white text-lg bg-indigo-950 hover:bg-blue-950  ">
                                    Comprar ahora
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="py-6">
                            <div>
                                <div class=" py-2 mt-7 ">
                                    <div data-menu class="flex justify-between items-center cursor-pointer">
                                        <p class="text-lg leading-4 text-blue-950 ">Materiales</p>
                                        <button
                            ...
                            <div>
                                <div class="py-2 mt-7 ">
                                    <div data-menu class="flex justify-between items-center cursor-pointer">
                                        <p class="text-lg leading-4 text-blue-950 ">Detalles</p>
                                        <button
                                            class="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded"
                                            role="button" aria-label="show or hide">
                                            <img class="transform "
                            ...
                            <div>
                                <div class="py-2 mt-7 ">
                                    <div data-menu class="flex justify-between items-center cursor-pointer">
                                        <p class="text-lg leading-4 text-blue-950 ">Envios</p>
                                        <button
                                            class="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded"
                                            role="button" aria-label="show or hide">
                                            <img class="transform "
