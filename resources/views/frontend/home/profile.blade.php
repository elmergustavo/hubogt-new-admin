            ...
            <aside id="sidebar-userdash" class="sidebar-userdash border-r  border-gray-300 p-6 md:block hidden">
                ...
                <header class="flex justify-center items-center flex-col text-center mb-5 gap-2">
                    <img src="{{ Storage::url(Auth::user()->profile_photo_path) }}"
                        class="w-[100px] h-[100px] object-cover rounded-full" alt="image" />
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <a href="{{ route('logout') }}" class="flex items-center  py-2 px-5" @click.prevent="$root.submit();">
                    ...
                    <h2 id="accordion-collapse-heading-user-dash">
                        <button type="button"
                            ...
                            <p class="text-center  flex flex-wrap">
                                <span class="text-blue-900 font-bold md:text-lg text-base">Diego Francisco Lopez
                                    Alvarado</span>
                    ...
                    <div id="accordion-collapse-body-user-dash" class="hidden p-3 !bg-gray-100"
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <button name="cards"
                                ...
                                guardadas</button>
                            <button name="orders"
                                class="btn-sidebar py-2 px-5 text-start hover:bg-blue-900 hover:text-white ">Ver
                                pedidos</button>
                            <button name="address"
                                class="btn-sidebar py-2 px-5 text-start hover:bg-blue-900 hover:text-white ">Dirección de
                                envió</button>
                ...
                <form class="md:w-[60%] w-full md:px-0 px-4 mx-auto py-8 pb-10 flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-3">
                        <input type="password" id="newPassword" name="newPassword"
                            placeholder="Ingrese nueva contraseña" class="p-3 px-4 border border-black ">
                    </div>
                    <div class="flex flex-col gap-3">
                                ...
                                <div class="lg:grid flex flex-wrap grid-cols-[1fr,40%] gap-5 items-start mt-10">
                                    <div
                                        ...
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <button
                                                class="p-2 bg-blue-900 mt-4 hover:bg-blue-950 text-white md:w-fit w-full">Comprar
                                                nuevamente</button>
                                        </div>
                                    </div>
