    ...
    <nav class=" md:shadow shadow-lg shadow-black/10 relative">
        <div
            ...
            <div
                ...
                <form id="form-search-navbar"
                    ...
                    <input name="search" placeholder="Busca lo que se te ocurra" type="text"
                        class="rounded-full w-full md:text-base text-sm p-2 pl-5 pr-10 text-base outline-none"
                        autocomplete="off" />
                    ...
                    <button
                        class=" outline-none grid place-items-center aspect-square absolute top-1/2 -translate-y-1/2 right-1 rounded-full bg-blue-950 active:bg-blue-900 transition-all text-white size-[32px] grid place-items-center"
                        id="btn-submit">
                        <svg xmlns="http://www.w3.org/2000/svg" class="md:size-[20px] size-4" viewBox="0 0 24 24">
                    ...
                    <button
                        class="absolute top-1/2 -translate-y-1/2 right-1 h-fit p-2 place-items-center grid hover:bg-gray-100 active:bg-gray-200 rounded-full hidden"
                        id="btn-clear" type="button">
            ...
            <div class="hidden lg:flex items-center md:gap-5 gap-3 lg:order-3 order-2">
                ...
                @endauth
                <a href="" id="button-like-navbar" class="relative">
    ...
    <div id="drawer-navbar-mobile"
        ...
        <div class="bg-white sm:w-[50%] w-[80%]  h-full absolute top-0 z-50">
            ...
            <section class="px-3 py-5 text-lg">
                ...
                <hr class="border border-gray-300/90 my-5" />
    ...
    <!-- start utils/categories-navbar.js  -->
    ...
    <!-- end utils/categories-navbar.js  -->


    <!-- start /utils/drawer-navbar.js  -->
    <script>
    ...
    <!-- end /utils/drawer-navbar.js  -->



    <!-- start utils/search-input-navbar.js  -->
    ...
    <!-- end  utils/search-input-navbar.js  -->
