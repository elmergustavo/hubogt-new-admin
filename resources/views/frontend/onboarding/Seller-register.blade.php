...
<div x-data="{ current_step: 1, currentPage: 'page1' }">
    ...
    <div class="flex flex-col h-screen">
                ...
                <div aria-label="Progress">
                    <ol role="list" class="flex items-center">
                        @for ($i = 1; $i <= 5; $i++) <li class="relative " :class="{
                            ...
                            <a href="#" x-on:click.prevent="current_step = {{ $i }}" :class="{
        ...
        <div class="flex flex-col w-full justify-center items-center pt-4 sm:pt-12">
        ...
        <div class="flex flex-col w-full justify-center items-center h-screen">
            <div class="bg-white shadow-lg rounded-lg p-8">
                <div class="flex justify-between">
                    <label for="storeDepartment" class="block mb-2 text-sm font-medium text-gray-900">Departamento
                        de la tienda</label>
                    <select id="storeDepartment"
                        class="w-56 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
