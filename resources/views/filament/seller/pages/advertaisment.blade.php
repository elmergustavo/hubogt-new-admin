    ...
    <section class="py-12">
        <div class="container mx-auto flex flex-wrap">
            ...
            <div class="w-full md:w-1/2 p-4">
                ...
                <p class="text-gray-700 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque euismod justo eget tortor euismod, nec feugiat justo venenatis.</p>
            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/2 p-4">
                    <blockquote class="bg-white p-6 rounded shadow">
                        <p class="text-gray-700">"¡Increíble servicio! Rápido y confiable. Definitivamente volveré a comprar."</p>
