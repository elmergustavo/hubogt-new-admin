...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $customers = $this->withProgressBar(250, fn () => Customer::factory(1)
            ->has(Address::factory()->count(rand(1, 3)))
            ->create());
        $this->command->info('Shop customers created.');

        $this->command->warn(PHP_EOL . 'Creating shop products...');
        $products = $this->withProgressBar(25, fn () => Product::factory(1)->count(1)
        ->sequence(fn ($sequence) => [
        ...
        $orders = $this->withProgressBar(250, fn () => Order::factory(1)
