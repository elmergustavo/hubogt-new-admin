...
class DepartmentMunicipalityOptions {
    ...
    public static function getGuatemalaOptions()
    {
        return [
            '1'  => 'Guatemala',
    ...
    public static function getElProgresoOptions()
    {
        return [
            '1'  => 'Guastatoya',
            '2'  => 'Morazán',
    ...
    public static function getSacatepequezOptions()
    {
        return [
            '1'  => 'Antigua Guatemala',
            '2'  => 'Jocotenango',
    ...
    public static function getChimaltenangoOptions()
    {
        return [
            '1'  => 'Chimaltenango',
            '2'  => 'San José Poaquil',
            '3'  => 'San Martín Jilotepéque',
            '4'  => 'Comalapa',
            '5'  => 'Santa Apolonia',
            '6'  => 'Tecpán Guatemala',
            '7'  => 'Patzún',
    ...
    public static function getEscuintlaOptions()
    {
        return [
            '1'  => 'Escuintla',
    ...
    public static function getSantaRosaOptions()
    {
        return [
            '1'  => 'Cuilapa',
            '2'  => 'Barberena',
    ...
    public static function getSololaOptions()
    {
        return [
            '1'  => 'Sololá',
            '2'  => 'San José Chacayá',
    ...
    public static function getTotonicapanOptions()
    {
        return [
            '1'  => 'Totonicapán',
    ...
    public static function getQuezaltenangoOptions()
    {
        return [
            '1'  => 'Quezaltenango',
            '2'  => 'Salcajá',
    ...
    public static function getSuchitepequezOptions()
    {
        return [
            '1'  => 'Mazatenango',
            '2'  => 'Cuyotenango',
    ...
    public static function getRetalhuleuOptions()
    {
        return [
            '1'  => 'Retalhuleu',
            '2'  => 'San Sebastián',
    ...
    public static function getSanMarcosOptions()
    {
        return [
            '1'  => 'San Marcos',
    ...
    public static function getHuehuetenangoOptions()
    {
        return [
            '1'  => 'Huehuetenango',
            '2'  => 'Chiantla',
            ...
            '31' => 'Santa Ana Huista',
            '32' => 'La Unión Cantinil',
        ];
    }

    public static function getQuicheOptions()
    {
        return [
    ...
    public static function getBajaVerapazOptions()
    {
        return [
            '1'  => 'Salamá',
            '2'  => 'San Miguel Chicaj',
    ...
    public static function getAltaVerapazOptions()
    {
        return [
            '1'  => 'Cobán',
            '2'  => 'Santa Cruz Verapáz',
            '3'  => 'San Cristóbal Verapáz',
            '4'  => 'Tactic',
            '5'  => 'Tamahú',
            '6'  => 'Tucurú',
            '7'  => 'Panzós',
    ...
    public static function getPetenOptions()
    {
        return [
            '1'  => 'Flores',
            '2'  => 'San José',
    ...
    public static function getIzabalOptions()
    {
        return [
            '1'  => 'Puerto Barrios',
            '2'  => 'Livingston',
    ...
    public static function getZacapaOptions()
    {
        return [
            '1'  => 'Zacapa',
            '2'  => 'Estanzuela',
    ...
    public static function getChiquimulaOptions()
    {
        return [
            '1'  => 'Chiquimula',
            '2'  => 'San José La Arada',
    ...
    public static function getJalapaOptions()
    {
        return [
            '1'  => 'Jalapa',
            '2'  => 'San Pedro Pinula',
    ...
    public static function getJutiapaOptions()
    {
        return [
            '1'  => 'Jutiapa',
            '2'  => 'El Progreso',
    ...
    public static function getMunicipality($department)
    {
        switch ($department) {
            case 1:
                return self::getGuatemalaOptions();
                break;
            case 2:
                return self::getElProgresoOptions();
                break;
            case 3:
                return self::getSacatepequezOptions();
                break;
            case 4:
                return self::getChimaltenangoOptions();
                break;
            case 5:
                return self::getEscuintlaOptions();
                break;
            case 6:
                return self::getSantaRosaOptions();
                break;
            case 7:
                return self::getSololaOptions();
                break;
            case 8:
                return self::getTotonicapanOptions();
                break;
            case 9:
                return self::getQuezaltenangoOptions();
                break;
            case 10:
                return self::getSuchitepequezOptions();
                break;
            case 11:
                return self::getRetalhuleuOptions();
                break;
            case 12:
                return self::getSanMarcosOptions();
                break;
            case 13:
                return self::getHuehuetenangoOptions();
                break;
            case 14:
                return self::getQuicheOptions();
                break;
            case 15:
                return self::getBajaVerapazOptions();
                break;
            case 16:
                return self::getAltaVerapazOptions();
                break;
            case 17:
                return self::getPetenOptions();
                break;
            case 18:
                return self::getIzabalOptions();
                break;
            case 19:
                return self::getZacapaOptions();
                break;
            case 20:
                return self::getChiquimulaOptions();
                break;
            case 21:
                return self::getJalapaOptions();
                break;
            case 22:
                return self::getJutiapaOptions();
                break;
            default:
                return self::getGuatemalaOptions();
                break;
